...
import Table from '../components/Table/Contacts/Table';
import Pagination from '../components/Table/Contacts/Pagination';
import Modal from '../components/Table/Contacts/Modal';
import { RowData } from '../components/Table/Contacts/types';
import { fetchData, addRow, updateRow, deleteRow } from '../components/Table/Contacts/api';
